...
import "../assets/scss/_resources.scss"
        ...
        <Grid item xs={3}>
          <Paper className={classes.paper}>
            ...
            <h2 className={classes.paragraph}><br></br>Office for Students with Disabilities (OSD)</h2>
                <p>Do you have a disability, mental health condition, chronic illness or other impairment that may impact your McGill experience? Visit the Office for Students with Disabilities to find out about the services and resources available to students through the OSD. For more information, check out their <a href="https://www.mcgill.ca/osd/">website</a>.If you have any questions or concerns about accessibility during Frosh, please reach out to the Engineering Inclusivity Coordinator for more details at oweek.inclusivity@mcgilleus.ca</p>
          </Paper>
        </Grid>
        <Grid item xs={3}>
          <Paper className={classes.paper}>
